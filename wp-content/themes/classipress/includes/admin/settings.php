		...
		$this->tab_sections['structured_data']['listing'] = array(
			...
			'fields' => array(
				array(
					...
					'desc'   => sprintf( __( "Select Structured Data <a target='_blank' href='%s'>type</a> to be applied to each listing.", APP_TD ), 'https://schema.org/docs/full.html' ),
					'type'   => 'radio',
					'name'   => 'listing_schema',
					'values' => array(
		...
		$this->tab_sections['security']['settings'] = array(
			...
			'fields' => array(
				array(
					...
					'desc'	 => sprintf( __( "Restrict access by <a target='_blank' href='%s'>specific role</a>.", APP_TD ), 'https://wordpress.org/documentation/article/roles-and-capabilities/' ),
					'type'	 => 'select',
					'name'	 => 'admin_security',
					'values' => array(
		...
		$this->tab_sections['security']['recaptcha'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'tip' => __( 'Choose version 2 if you want to display a reCAPTCHA box on your website. Choose version 3 if you want to use the reCAPTCHA verification in the background.', APP_TD ),
				),
				array(
					'title'  => __( 'Score (v3)', APP_TD ),
					'type'   => 'select',
					'name'   => 'captcha_score',
					'values' => array(
						'0.1' => '0.1',
					...
					'tip' => __( 'Choose a score between 0.1 and 1.0. The higher the score, the more likely the user is a human. The lower the score, the more likely the user is a bot. A score of 0.5 is the recommended threshold.', APP_TD ),
				),
				array(
					'title'	 => __( 'Theme (v2)', APP_TD ),
					'type'	 => 'select',
					'name'	 => 'captcha_theme',
					'values' => array(
					...
					'tip' => __( 'Choose the color scheme of the reCAPTCHA v2 box.', APP_TD ),
				),
			),
		);
