...
<?php
		...
		$stats[ __( 'Support', APP_TD ) ] = html( 'a', array( 'href' => 'https://forums.appthemes.com' ), __( 'Forums', APP_TD ) );
	...
	private function get_orders_revenue() {
		...
		$revenue['total'] = floatval( $revenue_total );
		$revenue['week'] = floatval( $revenue_week );
