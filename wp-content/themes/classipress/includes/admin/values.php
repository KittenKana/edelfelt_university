...
$options_new_form = array(
	...
	array(
		...
		'desc' => '',
		'tip'  => __( 'If you do not want this new form live on your site yet, select inactive.', APP_TD ) . ' ' . __( 'If you want to use this form for all categories by default, select default.', APP_TD ),
		'id'   => 'form_status',
		'css'  => '',
		'std'  => '',
		'js'   => '',
		...
		'options' => array(
			...
			'default'  => __( 'Default Form', APP_TD ),
		),
	),
