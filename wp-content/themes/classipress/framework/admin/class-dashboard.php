...
class APP_Dashboard extends scbBoxesPage {
	...
	const NEWS_FEED        = 'https://feeds2.feedburner.com/appthemes';
	const TUTORIALS_FEED   = 'https://feeds.feedburner.com/AppThemesTutorials/';
	const MARKETPLACE_FEED = 'https://feeds.feedburner.com/AppThemesMarketplace/';
	const FORUM_FEED       = 'https://forums.appthemes.com/external.php?type=RSS2';
	 ...
	 *         Default 'stats', 'news', 'tutorials', 'marketplace'.
	 *
...
<?php
		...
		$sections['support'][ __( 'Support', APP_TD ) ] = html( 'a', array( 'href' => 'https://forums.appthemes.com', 'target' => '_blank' ), __( 'Forums', APP_TD ) );
