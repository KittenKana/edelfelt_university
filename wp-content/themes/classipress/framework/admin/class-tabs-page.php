...
abstract class APP_Tabs_Page extends scbAdminPage {
	...
	function page_loaded() {
		...
		/**
		 * Fires after settings tabs registered, but the page content is not
		 * loaded and the form is not handled yet.
		 *
		 * The dynamic portion of the hook related to the current pagehook.
		 *
		 * @param APP_Tabs_Page $this The settings page instance.
		 */
	...
	function page_content() {
		...
		/**
		 * Fires before settings page content generated
		 *
		 * The dynamic portion of the hook related to the current pagehook.
		 *
		 * @param APP_Tabs_Page $this The settings page instance.
		...
		if ( isset( $_GET['firstrun'] ) ) {
			/**
			 * Fires on a theme settings page after the theme changed version.
			 *
			 * Used for theme upgrade procedures. For manually triggering this
			 * action add argument firstrun=1 to the theme settings page URL.
			 */
