...
$cfg['blowfish_secret']					= ':u+a\"Z<G@!y$=_eU0s{smA|s$K*n>!+<' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_hnHPuBFJQ9Dkwf2MLecZVxO/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
